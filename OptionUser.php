                            ...
                            <?php while ($LineaDatos = $EUsuario->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td class="bg-light" scope="row">
                                        <a href="OptionUser.php?Id_Usuario=<?php echo $LineaDatos['Id_Usuario'];?>" data-bs-toggle="modal" data-bs-target="#UpdateUserModal" class="text-success text-decoration-none">
