...
--
-- Servidor: localhost
-- Tiempo de generación: 10-07-2023 a las 14:33:39
...
INSERT INTO `Usuario` (`Id_Usuario`, `Nombre`, `ApellidoP`, `ApellidoM`, `Telefono`, `Email`, `Id_Plantel`, `Id_TUsuario`, `UserName`, `Password`, `Online`, `EstatusUser`, `ImgUser`) VALUES
(1, 'José Luis', 'Chávez', 'Gómez', '56110999056', 'contacto@iscjoseluischavezg.mx', 1, 1, 'JlchavezG', '827ccb0eea8a706c4c34a16891f84e7b', 1, 1, '551186.jpeg'),
(2, 'David', 'Santiago', 'Carlos', '56-12-34-65-78', 'david@gconalepmex.edu.mx', 3, 2, 'DavidS', '01cfcd4f6b8770febfb40cb906715822', 0, 1, 'imgUser1.png');
